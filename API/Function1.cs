...
namespace API
{
    public class StockAPI
    {
        ...
        public StockAPI(ILogger<StockAPI> log, IGetAnnualReturnsRepository getAnnualReturnsRepository)
        {
            _logger = log;
            ...
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = null)] HttpRequest req)
        {
            ...
            name = name ?? data?.name;
            var result = await _getAnnualReturnsRepository.GetAnnualReturns("IBM");
